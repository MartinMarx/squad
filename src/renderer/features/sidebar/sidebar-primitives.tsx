...
const sidebarMenuItemClass =
  'flex w-full font-normal h-8 text-foreground-tertiary-muted rounded-md items-center hover:bg-background-tertiary-1 hover:text-foreground-tertiary gap-2 px-3 py-2 text-sm transition-all duration-fast ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 data-[active=true]:bg-background-tertiary-1 data-[active=true]:text-foreground data-[active=true]:font-medium';
