...
export const LeftSidebar: React.FC = observer(function LeftSidebar() {
  ...
  return (
    <div
      className={cn(
        'relative flex flex-col h-full bg-background-sidebar text-foreground-tertiary-muted transition-colors',
      ...
      <SidebarContainer className="min-h-0 w-full flex-1 border-r-0">
        ...
        <SidebarFooter>
          <SidebarMenu>
            ...
            >
              <span className="flex items-center gap-2">
                <Library className="h-5 w-5 text-foreground-tertiary-muted sm:h-4 sm:w-4" />
                Library
              </span>
            </SidebarMenuButton>
            <SidebarMenuButton
            ...
            >
              <span className="flex items-center gap-2">
                <Settings className="h-5 w-5 text-foreground-tertiary-muted sm:h-4 sm:w-4" />
                Settings
              </span>
