...
if (process.env.CI || process.env.SQUAD_SKIP_ELECTRON_REBUILD === '1') {
  process.exit(0);
}
...
const disablePty = process.env.SQUAD_DISABLE_PTY === '1';
const disableNativeDb = process.env.SQUAD_DISABLE_NATIVE_DB === '1';
